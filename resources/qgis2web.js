...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [164531.212958, 2692119.292414, 203459.923797, 2718558.623590], maxZoom: 20, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3825',
...
map.getView().fit([164531.212958, 2692119.292414, 203459.923797, 2718558.623590], map.getSize());
